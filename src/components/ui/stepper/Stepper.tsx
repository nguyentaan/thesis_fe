...
const verticalStepVariants = cva(
  [
    ...
    "data-[completed=true]:[&:not(:last-child)]:after:bg-[#1A1A1A]",
...
const StepButtonContainer: React.FC<StepButtonContainerProps> = ({
  isCurrentStep,
  isCompletedStep,
  children,
  isError,
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        // "data-[active=true]:bg-[#1A1A1A] data-[active=true]:border-primary data-[active=true]:text-primary-foreground",
        "data-[active=true]:border-primary data-[active=true]:text-secondary",
